...
public class HeadphoneFragment extends BaseFragment {

    private static final String TITLE = "Headphone";

    public static HeadphoneFragment newInstance() {

        HeadphoneFragment actionsFragment = new HeadphoneFragment();
    ...
    protected List<Rule> getRules() {
        return ruleService.getHeadphoneRules();
    }
