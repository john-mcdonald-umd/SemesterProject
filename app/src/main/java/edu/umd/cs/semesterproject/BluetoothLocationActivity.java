...
import edu.umd.cs.semesterproject.fragment.BluetoothLocationFragment;
...
public class BluetoothLocationActivity extends SingleFragmentActivity {
    ...
    protected Fragment createFragment() {
        ...
        return BluetoothLocationFragment.newInstance(userID);
    }


    public static Intent newIntent(Context context, String ruleID){
        Intent intent = new Intent(context, BluetoothLocationActivity.class);
